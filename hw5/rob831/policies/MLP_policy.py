...
class MLPPolicyAWAC(MLPPolicy):
    ...
    def update(self, observations, actions, adv_n=None, q_fn=None):
        ...
        #AWAC update
        # Find the log probability of the action then weight the advantage by it then find the expectation (mean)
        act_prob_dist = self.forward(observations) # The probability distribution of actions over each observation

        # Find the log probability of the actions we took for the policy
